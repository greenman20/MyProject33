# 🚨 Проблема: Blueprint классы не созданы!
...
### 6. Создайте BP_ThirdPersonGameMode
1. **Content Browser** → Right Click → **Blueprint Class**
